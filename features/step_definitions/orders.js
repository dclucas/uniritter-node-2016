...
this.Given(/^a valid order$/, function () {
        this.payload = {
            data: {
                type: 'orders',
                attributes: {
                    items: [{ product_id: '598b04ea-8c20-4240-9c2b-1d36350a8d34', quantity: 1}]
                    }
                }
            }
});
            ...
            payload = {
                data: {
                    ...
                    attributes: {
                        status: status,
                        items: [{
                            product_id: '598b04ea-8c20-4240-9c2b-1d36350a8d34',
                            quantity: 1
                        }]
                    }
                }
        ...
        if(condition=="is missing an item quantity")
        {
            this.payload = {
                data: {
                    type: 'orders',
                    attributes: {
                        items: [{ product_id: '598b04ea-8c20-4240-9c2b-1d36350a8d34', quantity: 0}]
                        }
                    }
                };
        }
